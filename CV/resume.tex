...
\begin{cventries}
	...
	{\def\arraystretch{1.15}{\begin{tabular}{ l l }
		Programming Languages (proficient):  & {\skill{ Python, C, \LaTeX, Mathematica}} \\
		Programming Languages (novice):  & {\skill{ HTML/CSS}} \\
		Software:  & {\skill{ Unix/Linux, Jupyter Notebook, Microsoft Office, Git}} \\
...
\begin{cventries}
	\cventry
	{Rogoszinski, Z., Hamilton D. P., 2019, ApJ, accepted, arXiv:1908.10969}
...
\begin{cventries}
	...
	{}
	\cventry
	{I studied cosmic ray origins in supernova remnants with Dr. John Hewitt.}
	{NASA GFSC Summer Internship}
	{NASA}
	{2014}
	{}
	\cventry
	{I analyzed the causes of the black-drop effect observed during the 2012 transit of Venus with Dr. Jay Pasachoff.}
	{Keck Northeast Astronomy Consortium Summer Research Fellow }
	{Williams College}
	{2013}
	{}
